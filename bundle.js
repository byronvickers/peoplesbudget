...
let act_finance_rates = [
  {destinationLatLong: [-35.311588, 149.140441], rate: 1467927},
...
let starting_point = [-35.281577, 149.128260];
  ...
  if (agentmap.state.ticks % 20 === 0){
    ...
    agentmap.agents.eachLayer(function(agent) {
      if(agent.trip.path.length == 0 ){
        ...
        agent.setTravelToPlace(L.latLng(destLatLong),{type: "unanchored", id: null}, 10, true, true)
      }
    })
  }
